...
function buildDeterministicRecommendation(raw, items, policy) {
  ...
  storyGroupCounts.set(heroGroup, 1);
...
- человек на лошади, бытовая сцена у воды и пустой вид озера — разные визуальные функции и не должны автоматически попадать в одну группу;
