...
- обычные горы, луга, юрты, дорога и животные не доказывают конкретную точку маршрута;
...
- неизвестный предмет называй нейтрально, но конкретный предмет можно назвать при отчётливых признаках;
