...
Promise.all([import("./lib/photo-services-config.mjs"), import("./google-photos-picker.js")]).then(async ([{ photoServicesReady, validatePhotoServicesConfig }, { GooglePhotosPicker }]) => {
