...
Promise.all([import("./lib/photo-services-config.mjs?v=22"), import("./google-photos-picker.js?v=22")]).then(async ([{ photoServicesReady, validatePhotoServicesConfig }, { GooglePhotosPicker }]) => {
