    ...
    for (let attempt = 0; attempt < 4; attempt++) {
      ...
      try {
        ...
        if (constraintError) {
          ...
          if (attempt < 3) {
            attemptPrompt = `${prompt}\n\nВАЖНО: предыдущий ответ не прошёл локальную проверку. Исправь его и верни весь результат заново. Ошибка: ${constraintError}. Каждый public_id из исходного списка должен встретиться ровно один раз; ничего не пропускай и не дублируй.`;
            continue;
          }
