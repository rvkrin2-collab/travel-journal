...
const indexHtml = `<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">${publicHead({ title: registryTrip.title, description: registryTrip.description, canonical: `/trips/${trip}/` })}<link rel="stylesheet" href="../../trip-editorial.css?v=2"></head><body data-trip-data="../../data/${trip}/journal.json"><main id="journal-content"></main><script src="../../trip-editorial.js?v=2"></script></body></html>`;
